...
const About = () => {
    return(
        <main className="about-container">
            ...
            <section className="eva-cortado">
                <img src={Eva} alt="Eva Cortado"/>
                <h2>Eva Cortado</h2>
                <p>VD & Grundare</p>
            </section>

            <img src={HeaderBottom} alt="Bottom header flowers" />
        </main>
    )
}
